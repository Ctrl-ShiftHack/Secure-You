  ...
  return (
    <textarea
      className={cn(
        ...
        // Use the alternate destructive tone for focus border + subtle glow
        "focus-visible:border-destructive-2 focus-visible:ring-destructive-2/20 focus-visible:ring-2 focus-visible:ring-offset-2",
        className,
      )}
      ref={ref}
      {...props}
